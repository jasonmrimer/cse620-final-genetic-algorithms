...
% Last Modified by GUIDE v2.5 06-Dec-2021 22:19:53
...
elite     = get(handles.elite,'Value');
eliteSize  = str2num(get(handles.eliteSize,'String'));
...
% --- Executes on button press in elite.
function elite_Callback(hObject, eventdata, handles)
% hObject    handle to elite (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of elite


% --- Executes on button press in hyrbridization.
function hyrbridization_Callback(hObject, eventdata, handles)
% hObject    handle to hyrbridization (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
