...
function [population, Fmax, Fmin, Faver, fitness_function]=genetic( ...
    ...
    population = initialise(population_size, chromosome_length, benchmark_domain_start, benchmark_domain_end, fitness_function, option);
    plot_baseline_benchmark(option, population, chromosome_length);

    for j=1:total_generations
        
        population = crossover_all_pop(population, benchmark_domain_start, benchmark_domain_end, fitness_function, ...
            chromosome_length, probability_of_crossover);
        if does_crowding==1
            population=crowding(population, population_size, chromosome_length, benchmark_domain_start, benchmark_domain_end, fitness_function, option);
        end
...
%         if does_crowding~=1
%             [child1, child2]=crossover(parent1, parent2, benchmark_domain_start, benchmark_domain_end, option, fitness_function, chromosome_length, probability_of_crossover);%crossover
%         end
...
function new_population = crossover_all_pop(population, benchmark_domain_start, benchmark_domain_end, benchmark_function, ...
            chromosome_length, probability_of_crossover)
